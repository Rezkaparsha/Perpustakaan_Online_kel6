...
if ($page === 'logout') {
    // hancurkan session dan balik ke login
    session_destroy();
...
// ----------------- HALAMAN PETUGAS -----------------
if ($role === 'petugas') {
    if ($page === 'dashboard') { include "views/PETUGAS/v_dasbord_petugas.php"; exit; }
...
// ----------------- HALAMAN PENGGUNA -----------------
if ($role === 'pengguna') {
    if ($page === 'dashboard') { include "views/PENGGUNA/dasbord_pengguna.php"; exit; }
