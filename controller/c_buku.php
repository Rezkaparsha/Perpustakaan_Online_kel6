...
//  TAMPILKAN SEMUA BUKU (dipakai v_daftar_buku.php)
if ($aksi == "") {
...
if ($aksi == "tambah") {
    ...
    if (!empty($_FILES['cover']['name'])) {
        ...
        if (!move_uploaded_file($_FILES['cover']['tmp_name'], $targetCover)) {
            echo "<script>alert('Upload cover gagal.'); window.location='../views/PETUGAS/v_daftar_buku.php';</script>";
            exit;
        }
    }
    ...
    if (!empty($_FILES['file_pdf']['name'])) {
        ...
        if (!move_uploaded_file($_FILES['file_pdf']['tmp_name'], $targetPDF)) {
            echo "<script>alert('Upload PDF gagal.'); window.location='../views/PETUGAS/v_daftar_buku.php';</script>";
            exit;
        }
    }
    ...
    echo "<script>alert('Buku berhasil ditambahkan!'); window.location='../views/PETUGAS/v_daftar_buku.php';</script>";
    exit;
}


//  EDIT BUKU — Ambil data berdasarkan ID
...
if ($aksi == "update") {
    ...
    echo "<script>alert('Buku berhasil diupdate!'); window.location='../views/PETUGAS/v_daftar_buku.php';</script>";
    exit;
}
...
if ($aksi == "hapus") {
    ...
    echo "<script>alert('Buku berhasil dihapus!'); 
          window.location='../views/PETUGAS/v_daftar_buku.php';</script>";
    exit;
}
