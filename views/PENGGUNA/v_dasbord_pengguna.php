...
<head>
  ...
  <style>
    ...
    .cover-img { height: 200px; object-fit: cover; border-radius: 8px; }
  </style>
</head>
<body>
            ...
            <div class="card p-3">
              <?php if (!empty($buku->cover)): ?>
                <img src="/PERPUSTAKAAN_kel6/uploads/cover/<?= htmlspecialchars($buku->cover) ?>" 
                     class="cover-img mb-3" alt="Cover Buku">
              <?php else: ?>
              ...
              <?php if (!empty($buku->file_pdf)): ?>
                <a href="/PERPUSTAKAAN_kel6/uploads/buku/<?= htmlspecialchars($buku->file_pdf) ?>" 
                   target="_blank" class="btn btn-primary w-100">📖 Baca Buku</a>
              <?php else: ?>
